...
export default function AdminOverviewPage() {
     ...
     return (
          <div className="space-y-6 p-4 md:p-6">
               <PageHeader title="Admin Dashboard" description="Overview of platform users and accounts" />
               ...
               <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <ChartCard
                         ...
                         description="Active vs suspended/inactive accounts"
                    >
                         {loading ? (
                              <div className="h-[220px] animate-pulse rounded-lg bg-muted/40" />
                         ) : (
               ...
               <Card className="rounded-3xl border-border bg-card shadow-sm">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 border-b">
                         <CardTitle className="text-base font-bold">Recent User Signups</CardTitle>

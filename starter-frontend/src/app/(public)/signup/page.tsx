               ...
               <div className="max-w-md w-full mx-auto flex flex-col justify-center py-6">
                    ...
                    <div className="mb-6">
                         ...
                         <p className="text-sm text-muted-foreground leading-relaxed">
                              Join StarterApp today to launch your SaaS. Create a free account to get started.
                         </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                         ...
                         <div className="grid sm:grid-cols-2 gap-4">
                              <div className="relative border border-border rounded-2xl px-4 py-2 bg-card focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 transition-all shadow-sm">
                                   <label htmlFor="firstName" className="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-0.5">
                                        First Name
                                   </label>
                                   <input
                                        id="firstName"
                              ...
                              <div className="relative border border-border rounded-2xl px-4 py-2 bg-card focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 transition-all shadow-sm">
                                   <label htmlFor="lastName" className="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-0.5">
                                        Last Name
                                   </label>
                                   <input
                                        id="lastName"
                         ...
                         {/* Phone Input */}
                         <div className="relative border border-border rounded-2xl px-4 py-2 bg-card focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 transition-all shadow-sm">
                              <label htmlFor="phone" className="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-0.5">
                                   Phone
                              </label>
                              <input
                                   id="phone"
                         ...
                         {/* Password Input */}
                         <div className="relative border border-border rounded-2xl px-4 py-2 bg-card focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 transition-all shadow-sm flex items-center justify-between">
                         ...
                         <Button type="submit" className="w-full rounded-2xl py-6 font-bold shadow-md shadow-primary/10 hover:scale-[1.01] active:scale-[0.99] transition-all bg-primary text-primary-foreground hover:bg-primary/95" disabled={isPending}>
                              ...
                              {isPending ? "Creating account..." : "Start Journey"}
                         </Button>
